...
$config['kakao_login']['client_id']     = "a0c10d1fa237662ef92188216ee55180";   // REST API 키를 입력
$config['kakao_login']['client_secret'] = "";   // 카카오는 Client Secret을 사용하지 않습니다. 공백으로 지정
$config['kakao_login']['redirect_uri']  = base_url('/oauth');
...
$config['kakao_login']['logout_url']      = "https://kapi.kakao.com/v2/user/me";
